...
import { Effect, Option, Array, Stream, identity } from "effect"
...
export class Changesets extends Effect.Service<Changesets>()("app/Changesets", {
  ...
  dependencies: [NodeFileSystem.layer, PullRequests.Default, Github.Default],
}) {}
